(() => {
    ...
    define("components/TotalChance", ["require", "exports", "localstorage/index"], function (require, exports, index_3) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        class TotalChance {
            constructor(element) {
    ...
    define("components/UndocumentedCasesMultiplicator", ["require", "exports", "localstorage/index"], function (require, exports, index_4) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        class UndocumentedCasesMultiplicator {
            constructor(element) {
                ...
                this.element.addEventListener("input", () => {
                    index_4.write("undocumentedCasesMultiplicator", this.element.value ? parseInt(this.element.value, 10) : 0);
                });
            }
        }
    ...
    define("components/index", ["require", "exports", "components/TotalChance", "components/UndocumentedCasesMultiplicator"], function (require, exports, TotalChance_1, UndocumentedCasesMultiplicator_1) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        const components = [TotalChance_1.TotalChance, UndocumentedCasesMultiplicator_1.UndocumentedCasesMultiplicator];
    ...
    define("index", ["require", "exports", "api/index", "components/index", "localstorage/index", "api/population/getGlobalPopulation"], function (require, exports, index_5, index_6, index_7, getGlobalPopulation_2) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        const { corona, population } = index_5.api;
        console.log("Hello World");
        addEventListener("DOMContentLoaded", () => {
            index_6.initComponents();
        });
        // Clear data
        index_7.write("totalChance", 0);
        index_7.write("currentPopulation", getGlobalPopulation_2.getGlobalPopulation());
        (() => __awaiter(void 0, void 0, void 0, function* () {
            const data = yield corona.getCurrent();
            index_7.write("currentConfirmed", data.confirmed);
            index_7.write("currentRecovered", data.recovered);
            index_7.write("currentDeaths", data.deaths);
        }))();
    });
