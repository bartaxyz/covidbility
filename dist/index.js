(() => {
    ...
    define("data/countries", ["require", "exports"], function (require, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        exports.countries = [
            {
    ...
    define("components/TotalChanceTitle", ["require", "exports", "components/utils/Component", "localstorage/index", "data/countries"], function (require, exports, Component_10, index_17, countries_1) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
            ...
            refresh() {
                ...
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (countryNameElement) {
                        const countryName = (_a = countries_1.countries.find((country) => country.value === this.country)) === null || _a === void 0 ? void 0 : _a.text;
    ...
    define("api/ipapi", ["require", "exports"], function (require, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        let cachedData;
        let fetchPromise = fetch("https://ipapi.co/json").then((response) => response.json());
        exports.getIPApi = () => __awaiter(void 0, void 0, void 0, function* () {
            if (cachedData) {
                return cachedData;
            }
            const data = yield fetchPromise;
    ...
    define("index", ["require", "exports", "api/index", "components/index", "localstorage/index", "data/deathRate", "data/hospitalizationRate", "data/utils/getPopulation", "api/corona/getCorona", "api/ipapi", "data/countries"], function (require, exports, index_18, index_19, index_20, deathRate_2, hospitalizationRate_2, getPopulation_3, getCorona_3, ipapi_1, countries_2) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        ...
        (() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (ipCountryName) {
                const result = countries_2.countries.find((country) => country.text === ipCountryName || country.value === ipCountryName);
                if (result) {
                    index_20.write("country", result.value);
                }
            }
